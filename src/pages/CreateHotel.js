...
const CreateHotel = () => {
  const [formData, setFormData] = useState({
    ...
    address: 'Les îles du saloum, Mar Lodj',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await api.createHotel(formDataToSend, {
        headers: {
      ...
      setError(error.message || 'Erreur lors de la création de l\'hôtel');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="create-hotel-content">
      <div className="create-hotel-header">
        ...
        <h1 className="create-hotel-title">CRÉER UN NOUVEAU HÔTEL</h1>
      </div>
